...
class WorkerLoggingTests(unittest.TestCase):
    ...
    def test_preview_worker_uses_resident_process_for_litevggt_cache(self) -> None:
        ...
        main_source = source.split("def main", 1)[1].split("def run_preview_task_in_process", 1)[0]
        self.assertNotIn("run_task_in_subprocess(task_id, worker_id, redis_client, run_preview_task", main_source)
