...
class StorageResponseTests(unittest.TestCase):
    ...
    def test_pipeline_parameter_schema_lists_supported_pipelines_and_fields(self) -> None:
        with TestClient(app) as client:
            ...
            self.assertEqual(pipelines[FINE_PIPELINE_NAME]["defaults"]["indoor"]["pts_N_pts"], 200000)
            self.assertEqual(pipelines[FINE_PIPELINE_NAME]["defaults"]["indoor"]["pts_iter"], 2500)
            self.assertEqual(pipelines[FINE_PIPELINE_NAME]["defaults"]["indoor"]["pts_rate"], 1.1)
            self.assertEqual(pipelines[FINE_PIPELINE_NAME]["defaults"]["indoor"]["resolution"], 4)
