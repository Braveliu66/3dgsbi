...
class FlashInferAttention(Attention):
    ...
    def forward(self, x: Tensor, pos=None,
        ...
        # ========== Streaming Mode (with FlashInferKVCacheManager) ==========
            ...
            # Phase 1 (scale frames): num_frames > 1 鈥?multi-frame batch
            # Phase 2 (streaming):    num_frames == 1 鈥?single frame
...
class SDPAAttention(Attention):
    ...
    No FlashInfer dependency required 鈥?works on any CUDA GPU.
    """
