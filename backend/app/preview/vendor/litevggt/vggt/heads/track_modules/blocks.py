...
class CorrBlock:
    def __init__(self, fmaps, num_levels=4, radius=4, multiple_track_feats=False, padding_mode="zeros"):
        ...
        # delta: for every (dy,dx) displacement (i.e. 螖x, 螖y)
    ...
    def corr_sample(self, targets, coords):
        ...
        Args:
          targets: Tensor (B, S, N, C) 鈥?features for the current targets.
          coords: Tensor (B, S, N, 2) 鈥?coordinates at full resolution.
