...
def run(ctx: PreviewContext) -> PreviewResult:
    ...
    params = {
        ...
        "mode": str(ctx.options.get("preview_lingbot_mode") or "streaming"),
        "keyframe_interval": read_int(ctx.options.get("preview_lingbot_keyframe_interval"), 6, minimum=1, maximum=100_000),
