...
from .clustering import image_clustering, get_distance_matrix, find_best_image_clustering
    ...
    def register_candidate_cluster(self, images, distance_matrix, clusters,
        ...
        for avg_dist, global_kf_cluster in top_k_global_clusters:
            ...
            if candidate_kf_idx not in candidate_results:
                ...
                if 'intrinsic' in candidate_results[candidate_kf_idx] and 'intrinsic' in aligned_res:
    ...
    def coarse_registration(self, images, distance_matrix, rest_clusters_kf_indices, clusters):
        ...
        while True:
            ...
            while len(rest_clusters_kf_indices) > 0:
                ...
                if 'intrinsic' in best_candidate_result:
                    best_candidate_result_filtered['intrinsic'] = best_candidate_result['intrinsic'][high_conf_mask]
