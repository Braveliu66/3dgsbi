...
INDOOR_PROFILE = SceneProfile(
    ...
    late_prune_min_opacity=0.005,
    late_prune_score_thresh=0.95,
    final_prune_min_opacity=0.005,
    final_prune_score_thresh=0.90,
    sharp_refine_from=26_000,
...
OUTDOOR_PROFILE = SceneProfile(
    ...
    max_prune_fraction_per_step=0.20,
    ...
    late_prune_min_opacity=0.04,
    late_prune_score_thresh=0.95,
    final_prune_min_opacity=0.04,
    final_prune_score_thresh=0.90,
    sharp_refine_from=22_000,
    sharp_refine_clear_only="false",
