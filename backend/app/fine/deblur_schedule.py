...
INDOOR_PROFILE = SceneProfile(
    name="indoor",
    size_prune_world_scale_ratio=0.18,
    late_prune_world_scale_ratio=0.18,
    final_prune_world_scale_ratio=0.15,
    ...
    knn_k=6,
    knn_depth_limit=0.8,
    late_prune_from=40_000,
    late_prune_until=40_000,
    late_prune_interval=4_000,
    late_prune_min_opacity=0.001,
    late_prune_score_thresh=0.97,
    final_prune_min_opacity=0.001,
    final_prune_score_thresh=0.95,
    sharp_refine_from=36_000,
    sharp_refine_clear_only="false",
    densify_until_iter=34_000,
    deblur_warmup_iters=3_000,
)
