...
- Image fine reconstruction uses the active `dash_deblur_group_gs` pipeline: JPG/PNG or extracted-frame normalization, blur analysis, optional low-quality frame filtering, PyCOLMAP-compatible `images/` + `sparse/0`, motion/defocus DashDeblurGroupGS training, and Spark SPZ conversion.
